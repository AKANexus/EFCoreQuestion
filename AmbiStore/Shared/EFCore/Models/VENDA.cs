...
namespace AmbiStore.Shared.EFCore.Models
{
    public class VENDA : EntityBase
    {
        ...
        public Status_Nota STATUS { get; set; }
        [MaxLength(15)]
        [Column(TypeName = "NUMERIC(18,4)")]
        ...
        [NotMapped]
        public decimal DESCONTO_SUBTOTAL { get; set; }
        [NotMapped]
        public string CPF_CNPJ { get; set; } = "";
        //=======================
        public int NATUREZA_OPERACAO_ID { get; set; } = 1;
        ...
        public int? TRANSPORTADORA_ID { get; set; } = -2;
        public CONTATO TRANSPORTADORA { get; set; }
        public int VENDEDOR_ID { get; set; } = -1;
        public FUNCIONARIO VENDEDOR { get; set; }
        public int CLIENTE_ID { get; set; } = -2;
